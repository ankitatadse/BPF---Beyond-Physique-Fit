  ...
  function initiateRazorpay() {
    // NOTE: In production, create an order via your backend API first
    // and pass order_id here. Never expose secret key on frontend.
    const options = {
      ...
      image: '',
      // order_id: 'order_XXXXXX',  // Get from your backend — required for production
      handler: function(response) {
        ...
        // Send payment confirmation to Make.com
  ...
  async function sendToMake(data) {
    ...
    try {
      await fetch(CONFIG.MAKE_WEBHOOK_URL, {
        ...
        mode: 'no-cors',  // Make webhooks accept no-cors
      });
    } catch (err) {
